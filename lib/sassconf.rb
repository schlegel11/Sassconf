...
module Sassconf
  ...
  def self.start
    begin
      ...
      eval_and_execute(config_manager, executor, option_args)
  ...
  def eval_and_execute(config_manager, sass_executor, option_args)
  ...
  module_function :eval_and_execute, :cmd_check
end
